...
const CARDS = [
  {
    ...
    description:
      'The simulations are ever ready to use the data from an external prospects and can be used at any time.'
  },
  {
  ...
  },
  {
    ...
    title: 'Recreating the models',
    description: 'You can redefine and visualise the same machine again and aggain with real time dimensions'
  }
];
